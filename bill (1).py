...
class Bill_App:
    def __init__(self,root):
       ...
       #===========================Cosmetic Frame========================================
        ...
        g3_lbl = Label(F3, text="Pulses", font=("times new roman", 16, "bold")
                           , bg=bg_color, fg="lightgreen").grid(row=2, column=0, padx=10, pady=10, sticky="w")
        g3_txt = Entry(F3, width=10,textvariable=self.pulses,font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=2, column=1,
                                                                                                         padx=10,pady=10)
        ...
        # ===========================Soft Drinks Frame========================================
        F4 = LabelFrame(self.root, bd=10, relief=GROOVE, text="Soft Drinks", font=("times new roman", 15, "bold"),
                        fg="gold", bg=bg_color)
        F4.place(x=715, y=180, width=325, height=380)

        s1_lbl = Label(F4, text="Coke", font=("times new roman", 16, "bold")
                       , bg=bg_color, fg="lightgreen").grid(row=0, column=0, padx=10, pady=10, sticky="w")
        s1_txt = Entry(F4, width=10,textvariable=self.coke,font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=0, column=1,
                                                                                                     padx=10, pady=10)

        s2_lbl = Label(F4, text="Maaza", font=("times new roman", 16, "bold")
                       , bg=bg_color, fg="lightgreen").grid(row=1, column=0, padx=10, pady=10, sticky="w")
        s2_txt = Entry(F4, width=10,textvariable=self.maaza,font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=1, column=1,
                                                                                                     padx=10, pady=10)

        s3_lbl = Label(F4, text="Fanta", font=("times new roman", 16, "bold")
                       , bg=bg_color, fg="lightgreen").grid(row=2, column=0, padx=10, pady=10, sticky="w")
        s3_txt = Entry(F4, width=10,textvariable=self.fanta,font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=2, column=1,
                                                                                                     padx=10, pady=10)

        s4_lbl = Label(F4, text="Sprite", font=("times new roman", 16, "bold")
                       , bg=bg_color, fg="lightgreen").grid(row=3, column=0, padx=10, pady=10, sticky="w")
        s4_txt = Entry(F4, width=10,textvariable=self.sprite,font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=3, column=1,
                                                                                                     padx=10, pady=10)

        s5_lbl = Label(F4, text="Limca", font=("times new roman", 16, "bold")
                       , bg=bg_color, fg="lightgreen").grid(row=4, column=0, padx=10, pady=10, sticky="w")
        s5_txt = Entry(F4, width=10,textvariable=self.limca,font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=4, column=1,
                                                                                                     padx=10, pady=10)

        s6_lbl = Label(F4, text="Appy Fizz", font=("times new roman", 16, "bold")
                       , bg=bg_color, fg="lightgreen").grid(row=5, column=0, padx=10, pady=10, sticky="w")
        s6_txt = Entry(F4, width=10,textvariable=self.appy_fizz,font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=5, column=1,
                                                                                                     padx=10, pady=10)

        #===============================Bill Area=============================================
        F5 = Frame(self.root, bd=10, relief=GROOVE)
        F5.place(x=1070, y=180, width=440, height=380)
        ...
        m3_lbl = Label(F6, text="Total Soft Drinks Price", bg=bg_color, fg="white",
        ...
        c3_lbl = Label(F6, text="Soft Drinks Tax", bg=bg_color, fg="white",
                       font=("times new roman", 15, "bold")).grid(row=2, column=2, padx=20, pady=1, sticky="w")
        c3_txt = Entry(F6, width=18, font="arial 10 bold", textvariable=self.soft_drink_tax,bd=7, relief=SUNKEN).grid(row=2, column=3, padx=10, pady=1)

        btn_F=Frame(F6,bd=7,relief=GROOVE)
        btn_F.place(x=760,width=750,height=105)

        Total_btn=Button(btn_F,command=self.total,text="Total",bg="cadetblue",fg="white",bd=5,
                         pady=15,width=13,font="arial 14 bold").grid(row=0,column=0,padx=5,pady=5)
        GBill_btn = Button(btn_F, text="Generate Bill", command=self.bill_area,bg="cadetblue", fg="white", bd=5,
                           pady=15, width=13, font="arial 14 bold").grid(row=0, column=1, padx=5, pady=5)
        Clear_btn = Button(btn_F, text="Clear", command=self.clear_data,bg="cadetblue", fg="white", bd=5,
                           pady=15, width=13, font="arial 14 bold").grid(row=0, column=2, padx=5, pady=5)
        Exit_btn = Button(btn_F, text="Exit", command=self.Exit_app,bg="cadetblue", fg="white", bd=5,
                           pady=15, width=13, font="arial 14 bold").grid(row=0, column=3, padx=5, pady=5)
        self.welcome_bill()
    ...
    def total(self):
        ...
        self.c_hs_p = self.spray.get()*200
        ...
        self.d_c_p=self.coke.get()*90
        self.d_m_p=self.maaza.get() *55
        self.d_f_p=self.fanta.get()*60
        self.d_s_p=self.sprite.get()*70
        self.d_l_p=self.limca.get()*70
        self.d_a_p=self.appy_fizz.get()*40
    ...
    def bill_area(self):
        if self.c_name.get()=="" or self.c_phone.get()=="":
        ...
        elif self.cosmetic_price.get()=="Rs. 0.0" and self.grocery_price.get()=="Rs. 0.0" and self.soft_drink_price.get()=="Rs. 0.0":
            ...
            if self.pulses.get() != 0:
                self.txtarea.insert(END, f"\n Pulses\t\t{self.face_wash.get()}\t\t{self.g_p_p}")
            if self.wheat.get() != 0:
                self.txtarea.insert(END, f"\n Wheat\t\t{self.spray.get()}\t\t{self.g_w_p}")
            if self.sugar.get() != 0:
                self.txtarea.insert(END, f"\n Sugar\t\t{self.gel.get()}\t\t{self.g_s_p}")
            if self.tea.get() != 0:
                self.txtarea.insert(END, f"\n Tea\t\t{self.lotion.get()}\t\t{self.g_t_p}")

            # ==============================Soft Drinks====================================
            if self.coke.get() != 0:
                self.txtarea.insert(END, f"\n Coke\t\t{self.soap.get()}\t\t{self.d_c_p}")
            if self.maaza.get() != 0:
                self.txtarea.insert(END, f"\n Maaza\t\t{self.face_cream.get()}\t\t{self.d_m_p}")
            if self.fanta.get() != 0:
                self.txtarea.insert(END, f"\n Fanta\t\t{self.face_wash.get()}\t\t{self.d_f_p}")
            if self.sprite.get() != 0:
                self.txtarea.insert(END, f"\n Sprite\t\t{self.spray.get()}\t\t{self.d_s_p}")
            if self.limca.get() != 0:
                self.txtarea.insert(END, f"\n Limca\t\t{self.gel.get()}\t\t{self.d_l_p}")
            if self.appy_fizz.get() != 0:
                self.txtarea.insert(END, f"\n Appy Fizz\t\t{self.lotion.get()}\t\t{self.d_a_p}")
